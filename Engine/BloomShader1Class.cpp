////////////////////////////////////////////////////////////////////////////////
// Filename: BloomShader1Class.cpp
////////////////////////////////////////////////////////////////////////////////
#include "BloomShader1Class.h"


BloomShader1Class::BloomShader1Class()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
BloomShader1Class::BloomShader1Class(const BloomShader1Class& other)
{
}
...
bool BloomShader1Class::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;
	//The new texture.vs and texture.ps HLSL files are loaded for this shader.

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"../Engine/texture_vs.hlsl", L"../Engine/bloom_ps.hlsl");
	if (!result)
	{
		return false;
	}
...
void BloomShader1Class::Shutdown()
{
...
bool BloomShader1Class::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
bool BloomShader1Class::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "BloomPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
...
//The ShutdownShader function releases all the variables used in the BloomShader1Class.

void BloomShader1Class::ShutdownShader()
{
...
void BloomShader1Class::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool BloomShader1Class::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
...
void BloomShader1Class::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
