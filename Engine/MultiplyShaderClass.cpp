////////////////////////////////////////////////////////////////////////////////
// Filename: MultiplyShaderClass.cpp
////////////////////////////////////////////////////////////////////////////////
#include "MultiplyShaderClass.h"


MultiplyShaderClass::MultiplyShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
MultiplyShaderClass::MultiplyShaderClass(const MultiplyShaderClass& other)
{
}
...
bool MultiplyShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;
	//The new texture.vs and texture.ps HLSL files are loaded for this shader.

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"../Engine/texture_vs.hlsl", L"../Engine/textureMul_ps.hlsl");
	if (!result)
	{
		return false;
	}
...
void MultiplyShaderClass::Shutdown()
{
...
bool MultiplyShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
bool MultiplyShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
//The ShutdownShader function releases all the variables used in the MultiplyShaderClass.

void MultiplyShaderClass::ShutdownShader()
{
...
void MultiplyShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool MultiplyShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* texture2)
{
	HRESULT result;
...
void MultiplyShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
