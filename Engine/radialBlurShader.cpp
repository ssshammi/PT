////////////////////////////////////////////////////////////////////////////////
// Filename: RadialBlurShaderClass.cpp
////////////////////////////////////////////////////////////////////////////////
#include "radialBlurShader.h"


RadialBlurShaderClass::RadialBlurShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
RadialBlurShaderClass::RadialBlurShaderClass(const RadialBlurShaderClass& other)
{
}
...
bool RadialBlurShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;
...
void RadialBlurShaderClass::Shutdown()
{
...
bool RadialBlurShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
bool RadialBlurShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
//The ShutdownShader function releases all the variables used in the RadialBlurShaderClass.

void RadialBlurShaderClass::ShutdownShader()
{
...
void RadialBlurShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool RadialBlurShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
...
void RadialBlurShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
