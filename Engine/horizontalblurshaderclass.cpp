...
bool HorizontalBlurShaderClass::Initialize(ID3D11Device* device, HWND hwnd, WCHAR* VShaderName, WCHAR* PShaderName)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, VShaderName/*L"../Engine/horizontalblur.vs"*/, PShaderName/* L"../Engine/horizontalblur.ps"*/);
	if(!result)
	{
		return false;
	}
